...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    Choice croom; //not JChoice same as JComboBox but with add function
    JLabel checkintime;
    JButton add,back;
    ...
    AddCustomer(){
        ...
        croom = new Choice();// from room table, all value are required/taken from database like roomnumber, etc but onlu need roomnumber value eg 101
        try{
            Conn conn = new Conn();
        ...
        checkintime = new JLabel("" + date); // for not editable field userr can't but system do //date convert into string
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try{
                ...
                setVisible(false);//curent frame close
                new Reception();//Reception frame open
