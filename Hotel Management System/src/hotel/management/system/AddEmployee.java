...
public class AddEmployee  extends JFrame implements ActionListener {
    ...
    AddEmployee() {
        ...
        String str[] ={ "Front Desk Clerks", "Porters", "Housekeeping", "Kitchen staff", "Room Service","Managers","Accountant"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String gender = null;//intially null set
        ...
        String job = (String)cbjob.getSelectedItem();//typecast in string becoz it returns object
